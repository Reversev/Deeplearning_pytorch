...
def argspar():
    ...
    parser.add_argument('--model-name', type=str, default='sppnet',
                        help='model name: sppnet')
    ...
    parser.add_argument('--load_model', default='./sppnet_5_224.pth', type=str,
