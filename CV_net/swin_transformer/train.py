...
def argspar():
    ...
    parser.add_argument('--model-name', type=str, default='swin_tiny',
                        help='model name: swin_tiny, swin_small, swin_base, '
    ...
    parser.add_argument('--load_model', default='./swin_tiny_224.pth', type=str,
