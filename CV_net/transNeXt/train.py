...
from transNeXt import create_transnext
...
def parse_option():
    ...
    parser.add_argument('--arch', metavar='ARCH', default='transnext_micro', type=str,
                        help='transnext_micro, transnext_tiny, transnext_small, transnext_base')
...
def main_worker(gpu, ngpus_per_node, log, args):
    ...
    model = create_transnext(model_name=args.arch, num_classes=args.num_classes)
