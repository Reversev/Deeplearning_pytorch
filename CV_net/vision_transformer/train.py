...
def argspar():
    ...
    parser.add_argument('--model-name', type=str, default='vitbase16',
                        help='model name: vitbase16, vitbase32, vitlarge16, '
    ...
    parser.add_argument('--load_model', default='./vit_base_patch16_224.pth', type=str,
