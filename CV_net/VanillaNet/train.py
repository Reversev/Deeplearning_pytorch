...
def argspar():
    parser = argparse.ArgumentParser(description='Vanillanet PyTorch Training')
    ...
    parser.add_argument('--model-name', type=str, default='vanillanet_5',
                        help='model name: vanillanet_6, vanillanet_7, vanillanet_9, '
    ...
    parser.add_argument('--load_model', default='./vanillanet_5_224.pth', type=str,
