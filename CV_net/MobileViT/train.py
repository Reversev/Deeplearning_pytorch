...
def parse_option():
    ...
    parser.add_argument('-a', '--arch', metavar='ARCH', default='mobilevit_xxs', help='mobilevit_xxs, mobilevit_xs, mobilevit_s')
...
def main_worker(gpu, ngpus_per_node, log, args):
    ...
    model = create_mobilevit(model_name=args.arch, num_classes=args.num_classes)
