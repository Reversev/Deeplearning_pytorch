...
from model import DenseNet121, DenseNet169, DenseNet201, DenseNet161


def main():
    model_name = 'DenseNet121'   # resnet18, resnet34, resnet50, resnet101, resnet152
    ...
    net = DenseNet121(num_classes=CLASS_NUM)
    # load pretrain weights
    assert os.path.exists(LOAD_PATH), "file {} does not exist.".format(LOAD_PATH)
    net.load_state_dict(torch.load(LOAD_PATH, map_location=device))
    # for param in net.parameters():
    #     param.required_grad = False

    # change layers structure
