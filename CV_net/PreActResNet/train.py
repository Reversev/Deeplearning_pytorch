...
from preresnet_cifar import model_list
...
def argspar():
    ...
    parser.add_argument('--model-name', type=str, default='preact_resnet164_cifar',
                        help='model name: preact_resnet110_cifar, preact_resnet164_cifar, preact_resnet1001_cifar')
...
def main():
    ...
    layers = args.model_name[13:].split("_")[0]
    net = model_list.get(layers)(num_classes=CLASS_NUM)
